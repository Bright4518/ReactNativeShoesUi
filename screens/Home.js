...
const Home = () => {
    ...
    const [trending, setTrending] = React.useState([
        ...
        {
            id: 2,
            name: "Nike Air Zoom Kobe l propo",
    ...
    function renderTrendingShoes(item, index) {
        ...
        return (
            ...
            >
                <Text
                    style={{ color:COLORS.gray, ...FONTS.h5}}
                >
                    {item.type}
                </Text>
    ...
    function renderRecentlyViewed(item, index) {
        return (
            <TouchableOpacity
                ...
                onPress={() => {
                   // console.log("renderRecentlyview")
                    setSelectedItem(item)
                    setShowAddToBagModal(true)
                }}
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Trending */}
            <View
                style={{height:260,marginTop:SIZES.radius}}
            >
                <FlatList
                    horizontal
